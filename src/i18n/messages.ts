export const messages = {
  zh_CN: {
    ...
    promptLabel: "提示词",
    promptDescription: "输入的完整原文会直接作为请求发送；官方模式只把这段原文交给 Magic Prompt 优化。",
  ...
  en_US: {
    ...
    promptLabel: "Prompt",
    promptDescription: "The full original text is sent as entered; official mode sends that text only to Magic Prompt.",
    ...
    requestPreview: "Full Source Request",
